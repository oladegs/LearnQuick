...
const AIActions = () => {
  ...
  return (
    <>
      <div
        className="bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-xl
      shadow-slate-200/50 overflow-hidden"
      >
        {/* Header */}
...
<Modal
  ...
  title={modalTitle}
>
  <div className="max-h-[60vh] overflow-y-auto prose prpse-sm max-w-none prose-slate">
