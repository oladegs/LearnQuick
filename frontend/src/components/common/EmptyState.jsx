...
const EmptyState = ({ onActionClick, title, description, buttonText, icon: Icon = FileText }) => (
  <div className="surface-card flex flex-col items-center justify-center rounded-[20px] border-dashed px-6 py-14 text-center">
    <div className="mb-5 inline-flex h-16 w-16 items-center justify-center rounded-2xl border border-orange-200 bg-orange-50 text-orange-600 dark:border-orange-400/20 dark:bg-orange-500/10 dark:text-orange-300">
