...
const ForgotPasswordPage = () => {
  ...
  return (
    <AuthLayout eyebrow="Account recovery" title="Reset your password" subtitle="Enter your account email and we'll send you a secure, one-time reset link.">
      ...
      <Link to="/login" className="mt-6 flex min-h-11 items-center justify-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-700 dark:text-blue-300"><ArrowLeft className="h-4 w-4" />Back to sign in</Link>
    </AuthLayout>
  );
};
