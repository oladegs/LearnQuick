  ...
  return (
    <AuthLayout eyebrow="Welcome back" title="Continue learning" subtitle="Sign in with Google or use your LearnQuick email and password.">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-5">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between"><label htmlFor="login-password" className="text-xs font-bold text-stone-700 dark:text-stone-300">Password</label><Link to="/forgot-password" className="text-xs font-bold text-blue-600 hover:text-blue-700 dark:text-blue-300">Forgot password?</Link></div>
      ...
      <p className="mt-7 border-t border-stone-200 pt-6 text-center text-sm text-stone-600 dark:border-white/10 dark:text-stone-400">New to LearnQuick?{" "}<Link to="/register" className="font-bold text-blue-600 hover:text-blue-700 dark:text-blue-300">Create an account</Link></p>
    </AuthLayout>
  );
};
